...
`;const S=function(e){const{children:t,icon:n}=e;return a.createElement(O,{className:"menu-item"},n,a.createElement("span",{style:{marginLeft:8}},t))};var P=n(2253),N=n(7188);const C=i.ZP.div`
  user-select: none;
  .title {
    padding: 16px ${48}px;
    display: flex;
...
`;function A(){const e=(0,i.s0)(),[t,n]=a.useState(null),[l,s]=a.useState(0),[d,m]=a.useState("all"),[u,p]=a.useState(!1),[f,h]=a.useState(!0),g=t=>{e(`/admin/edit/add/${t}/0`)},v=(e=0,t=6)=>P(this,void 0,void 0,(function*(){const a=yield(0,o.T6)(e,t,{status:"all",type:d});"string"!=typeof a&&(p(!(e<=0)),e+t>=a.data.totals?h(!1):h(!0),n(a.data.posts))}));return a.useEffect((()=>{v(l,6)}),[l]),a.useEffect((()=>{s(0),v(0,6)}),[d]),a.createElement(N,null,a.createElement(c.h4,null,a.createElement(c.h4.Title,null,"内容管理"),a.createElement(c.h4.Add,null,a.createElement(r.z,{onClick:()=>g("article")},"新增文章"),a.createElement(r.z,{onClick:()=>g("photo")},"添加图片")),a.createElement("div",{style:{marginLeft:32}},a.createElement("span",null,"点击筛选"),a.createElement(r.z,{type:"primary",onClick:()=>m("all")},"所有"),a.createElement(r.z,{type:"primary",onClick:()=>m("article")},"文章"),a.createElement(r.z,{type:"primary",onClick:()=>m("photo")},"照片"),a.createElement(r.z,{type:"primary",onClick:()=>m("cover")},"封面"))),a.createElement(C,null,a.createElement("div",{className:"table"},a.createElement(w,{posts:t,onEdit:t=>{e(`/admin/edit/update/${t.type}/${t.uid}`)},onDel:e=>{const t=e.uid;confirm("确定要删除？")&&(()=>{P(this,void 0,void 0,(function*(){const e=yield(0,o.fR)(t);"string"!=typeof e?(window.alert("删除成功"),v()):window.alert(e)}))})()},onView:t=>{e(`/${t.type}/${t.uid}`)}})),a.createElement("div",{className:"prev-next"},a.createElement(r.z,{onClick:()=>{n(null),s(l-6)},disabled:!u},"Prev"),a.createElement(r.z,{onClick:()=>{n(null),s(l+6)},disabled:!f},"Next"))))}}}]);