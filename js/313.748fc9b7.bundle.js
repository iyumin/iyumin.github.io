...
`;function y(e){const{cover:t,verse:n}=e;return a.createElement(f,{style:{backgroundImage:`url(${t})`},className:"gallery-cover"},a.createElement(g,null,n&&n.content.map(((e,t)=>a.createElement("p",{key:t},e)))))}var v=n(5726),w=n.n(v),b=n(8459),E=n(6055);const k=p.ZP.div`
  position: relative;
`,x=p.ZP.div``,A=a.forwardRef(((e,t)=>{const[n,i]=a.useState(0),{cols:o=3,colWidth:s=320,gutter:l=8,data:r,onPreview:c,shadow:d=!1}=e,u=Array.from({length:o},(()=>0));let h=0;const m=(e,t)=>{const n=(()=>{const e=Math.min(...u);return u.indexOf(e)})(),a=(s+l)*n,i=u[n],o=s/e.width*e.height;return u[n]+=o+l,t===r.length-1&&(h=Math.max(...u)),{left:a,top:i,position:"absolute",width:s,height:o,cursor:"pointer",boxShadow:d?"4px 4px 4px rgba(0,0,0,0.35)":""}};return a.useEffect((()=>{i(h)}),[...u,r.length]),a.createElement(k,{style:{width:(s+l)*o-l,height:n},ref:t},r&&r.map(((e,t)=>{const{key:n,child:i}=e,o=m(e,t);return a.createElement(x,{style:Object.assign({},o),key:n,"data-key":n,"data-index":t,onClick:t=>((e,t)=>{c(e,t)})(t,e)},i)})))}));A.displayName="Masonry";var S=n(5159),Z=n(5008),P=function(e,t,n,a){return new(n||(n=Promise))((function(i,o){function s(e){try{r(a.next(e))}catch(e){o(e)}}function l(e){try{r(a.throw(e))}catch(e){o(e)}}function r(e){var t;e.done?i(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(s,l)}r((a=a.apply(e,t||[])).next())}))};const N=p.ZP.div`
  width: 100%;
  height: 100%;
  display: flex;
