...
`,S=(e,t)=>Object.assign(Object.assign({},e),t.payload);function O({user:e,onSuccess:t}){const[n,r]=i.useReducer(S,e),a=e=>{const t=e.target.dataset.name,n=e.target.value;r({type:"",payload:{[t]:n}})};return i.createElement("div",{tabIndex:0},i.createElement(N,null,i.createElement("div",{className:"edit-form"},i.createElement("div",{className:"item"},i.createElement("label",null,"头像"),i.createElement("div",{className:"upload-avatar"},i.createElement("div",null,n.avatar?i.createElement("img",{src:u._+n.avatar,alt:n.username}):i.createElement(M.Z,{url:u._+"/upload",onFinish:e=>r({type:"",payload:{avatar:e.url}}),allowExtensions:["jpg","png","jpeg","gif","webp"]})))),i.createElement("div",{className:"item"},i.createElement("label",null,"用户编码"),i.createElement(o.II,{"data-name":"uid",defaultValue:e.uid,value:n.uid,onChange:a,disabled:!0})),i.createElement("div",{className:"item"},i.createElement("label",null,"邀请码"),i.createElement(o.II,{"data-name":"invitation",defaultValue:e.invitation,value:n.invitation,onChange:a,disabled:Boolean(n.uid)})),i.createElement("div",{className:"item"},i.createElement("label",null,"用户名"),i.createElement(o.II,{"data-name":"username",defaultValue:e.username,value:n.username,onChange:a})),i.createElement("div",{className:"item"},i.createElement("label",null,"密码"),i.createElement(o.II,{"data-name":"password",defaultValue:"",value:n.password,onChange:a})),i.createElement("div",{className:"item"},i.createElement("label",null,"昵称"),i.createElement(o.II,{"data-name":"nickname",defaultValue:e.nickname,value:n.nickname,onChange:a})),i.createElement("div",{className:"item"},i.createElement("label",null,"性别"),i.createElement("div",{style:{width:188}},i.createElement(j.P,{defaultValue:e.gender,onChange:e=>r({type:"",payload:{gender:e}})},i.createElement(j.W,{value:"",name:"未知性别"}),i.createElement(j.W,{value:"male",name:"男性"}),i.createElement(j.W,{value:"female",name:"女性"})))),i.createElement("div",{className:"item"},i.createElement("label",null,"生日"),i.createElement(o.II,{"data-name":"birthday",defaultValue:e.birthday,value:n.birthday,onChange:a})),i.createElement("div",{className:"item"},i.createElement("label",null,"所在地"),i.createElement(o.II,{"data-name":"location",defaultValue:e.location,value:n.location,onChange:a})),i.createElement("div",{className:"item"},i.createElement("label",null,"用户描述"),i.createElement(o.II,{"data-name":"description",defaultValue:e.description,value:n.description,onChange:a})),i.createElement("div",{className:"item"},i.createElement("label",null,"格言"),i.createElement(o.II,{"data-name":"motto",defaultValue:e.motto,value:n.motto,onChange:a})),i.createElement("div",{className:"item"},i.createElement("label",null,"角色"),i.createElement(o.II,{"data-name":"role",defaultValue:e.role,value:n.role,onChange:a})),i.createElement("div",{className:"item"},i.createElement("label",null,"用户组"),i.createElement(o.II,{"data-name":"group",defaultValue:e.group,value:n.group,onChange:a}))),i.createElement("div",{className:"submit"},i.createElement(o.zx,{type:"primary",style:{width:200,height:40},onClick:()=>{n.uid?(()=>{W(this,void 0,void 0,(function*(){(yield function(e,t){return Z(this,void 0,void 0,(function*(){const n=u._+"/user?uid="+e;if(0===(yield d.Z.put(n,t)).data.code)return!0}))}(n.uid,n))?(window.alert("更新成功"),t&&t()):window.alert("添加失败")}))})():(()=>{W(this,void 0,void 0,(function*(){(yield function(e){return Z(this,void 0,void 0,(function*(){const t=u._+"/user";if(0===(yield d.Z.post(t,e)).data.code)return!0}))}(n))?(window.alert("添加成功"),t&&t()):window.alert("添加失败")}))})()}},n.uid?"更新":"注册"))))}var D=function(e,t,n,i){return new(n||(n=Promise))((function(r,a){function o(e){try{l(i.next(e))}catch(e){a(e)}}function s(e){try{l(i.throw(e))}catch(e){a(e)}}function l(e){var t;e.done?r(e.value):(t=e.value,t instanceof n?t:new n((function(e){e(t)}))).then(o,s)}l((i=i.apply(e,t||[])).next())}))};const z=a.ZP.div``,V=a.ZP.div`
  display: flex;
