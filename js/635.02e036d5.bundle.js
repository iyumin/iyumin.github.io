...
`;function o({width:t="100%",height:e=16}){return n.createElement(s,{className:"component-skeleton",style:{width:t,height:e}})}},8432:(t,e,r)=>{"use strict";r.d(e,{Gm:()=>u,IW:()=>a,N7:()=>l,ZE:()=>i,_n:()=>n,fo:()=>s,mS:()=>o,uh:()=>c});const n="https://api.kevinjobs.com:5000",a=n+"/upload",i=n+"/token",s=n+"/post/list",o=n+"/p",u=n+"/user/list",c=n+"/user",l=n+"/invitation/list"},1635:(t,e,r)=>{"use strict";r.r(e),r.d(e,{default:()=>y});var n=r(2983),a=r(9606),i=r(3891),s=r(7860),o=r.n(s),u=r(7952),c=r(9805),l=r(5577);const d=a.ZP.div`
  padding: 48px 0;
