...
`;function f(e){const{isOpen:t,onClick:n,menus:o}=e,r=(0,u.TH)(),s=e=>e.paths.join("/")===r.pathname&&t?"right-navi-menu-item actived":"right-navi-menu-item",l=e=>"hash"===e.type?"/#"+e.paths.join("/"):e.paths.join("/");return i.useEffect((()=>{const e=e=>{t&&e.preventDefault()};return window.addEventListener("wheel",e,{passive:!1}),()=>{window.removeEventListener("wheel",e)}}),[t]),i.createElement(i.Fragment,null,i.createElement(k,{className:"page-article-right-navi",style:{width:300,right:t?0:-256,backgroundColor:t?"#fff":"transparent"}},i.createElement("div",{style:{marginLeft:t?16:0,transition:"all .5s ease-in-out",cursor:"pointer"}},t?i.createElement(p,{theme:"outline",size:"32",fill:"#555555",strokeWidth:2,onClick:n}):i.createElement(h,{theme:"outline",size:"32",fill:"#d1d1d1",strokeWidth:2,onClick:n})),i.createElement(g,{style:{visibility:t?"visible":"hidden"}},o.map((e=>{if(2===e.paths.length)return i.createElement("div",{className:s(e),key:e.key},i.createElement("a",{href:l(e)},e.title))})))),t&&i.createElement(m,{style:{zIndex:998}}))}},2392:(e,t,n)=>{"use strict";n.r(t),n.d(t,{default:()=>H});var i=n(7294),o=n(9954),r=n(6486),s=n.n(r);const l=i.createContext({width:0,height:0,toTop:0,toBottom:0}),a=e=>{const{children:t}=e,[n,o]=i.useState(window.innerWidth),[r,a]=i.useState(window.innerHeight),[c,d]=i.useState(0),[p,h]=i.useState(0);function u(){o(window.innerWidth),a(window.innerHeight)}let m;return m=()=>{const e=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop||0,t=document.documentElement.clientHeight||document.body.clientHeight||0,n=(document.documentElement.scrollHeight||document.body.scrollHeight||0)-e-t;d(e),h(n)},i.useEffect((()=>(window.addEventListener("resize",u),window.addEventListener("scroll",s().debounce(m,500)),()=>{window.removeEventListener("resize",u),window.removeEventListener("scroll",s().debounce(m,500))})),[]),i.createElement(l.Provider,{value:{width:n,height:r,toTop:c,toBottom:p}},t)};var c=n(495),d=n(4203),p=n(9163);const h=p.ZP.div`
  width: 100%;
  height: 100vh;
...
`,W={position:"fixed",top:0,left:0,right:0,bottom:0,backgroundColor:"rgba(255,249,247,1)",zIndex:10,transition:"all .3s ease-in-out",filter:"opacity(98%)"};function C(){const[e,t]=i.useState(0),[n,o]=i.useState([]),[r,s]=i.useState(!1),[a,c]=i.useState(),[d,p]=i.useState(),[h,u]=i.useState(0),{clientWidth:m,clientHeight:k,device:f}=(()=>{let e="desktop";const{width:t,height:n}=i.useContext(l);return e=t<1080?"mobile":"desktop",{device:e,clientWidth:t,clientHeight:n}})(),{toBottom:C}=(()=>{const{toTop:e,toBottom:t}=i.useContext(l);return{toTop:e,toBottom:t}})(),H=i.useRef(),M=(e,t=12)=>{w.V.get(`/pictures?offset=${e}&limit=${t}&orderBy=createAt&order=desc`).then((e=>{if(1===e.data.code){const t=e.data.limit,i=e.data.offset,r=e.data.totals,l=e.data.data;o(n.concat(z(l))),s(!(i+t>r))}}))};i.useEffect((()=>{M(e,12)}),[]),i.useEffect((()=>{r&&C<500&&(M(e+12,12),t(e+12))}),[C]);const P=e=>{d&&e.preventDefault(d)};return i.useEffect((()=>(window.addEventListener("wheel",P,{passive:!1}),()=>{window.removeEventListener("wheel",P)})),[d]),i.createElement(x,null,i.createElement(y,null,0!==n.length?i.createElement(L.Rk,{data:n,cols:"mobile"===f?2:3,colWidth:"mobile"===f?(m-12)/2:320,gutter:"mobile"===f?4:24,onPreview:(e,t)=>{e.preventDefault();const n=H.current,i=e.target.parentNode.dataset.index,o=void 0!==n?n.children[i]:"",r=o.cloneNode(!0),s=o.getBoundingClientRect().width,l=o.getBoundingClientRect().height,a=o.getBoundingClientRect().top,d=o.getBoundingClientRect().left,{finalWidth:h,finalHeight:g,finalTop:f,finalLeft:v}=((e,t,n)=>{const i=e.width/e.height;let o;const r=.8*n;o=e.height>r?r:e.height;let s=o*i;return s>t&&(s=t,o=t/i),{finalWidth:s,finalHeight:o,finalTop:50,finalLeft:(t-s)/2}})(t,m,k);r.style.transition="all 0.3s ease-in-out",r.style.position="fixed",r.style.boxShadow="4px 4px 16px 8px rgba(0,0,0,0.35)",r.style.zIndex=999999,r.style.width=s+"px",r.style.height=l+"px",r.style.left=d+"px",r.style.top=a+"px",o.style.display="none",n.append(r),c(t),p(i),u(g+f),setTimeout((()=>{r.style.width=h+"px",r.style.height=g+"px",r.style.left=v+"px",r.style.top=f+"px"}),20),r.onclick=e=>{e.preventDefault(),r.style.width=s+"px",r.style.height=l+"px",r.style.left=d+"px",r.style.top=a+"px",setTimeout((()=>{n.removeChild(r),o.style.display="block"}),300),p(void 0),c(void 0)}},ref:H,shadow:!0}):i.createElement(L.gb,null),i.createElement(b,{style:d&&W},i.createElement(j,{style:{visibility:d?"visible":"hidden",position:"absolute",top:h+8,left:"50%",transform:"translateX(-50%)",flexWrap:"wrap"}},a?i.createElement(i.Fragment,null,i.createElement("div",{style:{width:"100%",textAlign:"center"}},i.createElement("h3",null,a.title)),i.createElement("span",{className:"mask-desc-item"},i.createElement(v,{theme:"outline",size:"20",fill:"#333",strokeWidth:2}),i.createElement("span",{style:{margin:"0 8px"}},g()(a.createAt).format("YYYY-MM-DD"))),i.createElement("span",{className:"mask-desc-item"},i.createElement(E,{theme:"outline",size:"20",fill:"#333",strokeWidth:2}),i.createElement("span",{style:{margin:"0 8px"}},a.description||"还没有图片说明"))):""))),r&&i.createElement(L.gb,null))}const z=e=>e.map(((e,t)=>{const n=e,o=e.source.toLowerCase();return n.key=e.uid,n.child=i.createElement("img",{src:o,"data-index":t,alt:e.title,style:{width:"100%",height:"100%"}}),n}));function H(){const[e,t]=i.useState(!1);return i.createElement(a,null,i.createElement(m,{cover:"\n    https://mintforge-1252473272.cos.ap-nanjing.myqcloud.com/background/kayle-kaupanger.jpg\n  ",verse:{createAt:"2021-08-02",updateAt:"2021-02-02",id:1,uid:"4646aeraedfladlfhadiofag",title:"soso",author:"yiming",content:["纵潮望海阔","一览似无余"]}}),i.createElement(C,null),i.createElement(c.$Y,{isOpen:e,onClick:n=>{n.preventDefault(),t(!e)},menus:o.ps}))}},7218:(e,t,n)=>{"use strict";n.d(t,{V:()=>s});var i=n(9669),o=n.n(i),r=n(4901);const s=o().create();let l;l="https://api.kevinjobs.com:5000/v2",s.defaults.baseURL="https://api.kevinjobs.com:5000/v2",s.interceptors.request.use((e=>(e.data=JSON.stringify(e.data),e.headers={"content-type":"application/json",Authorization:`Bearer ${localStorage.getItem("token")}`},e))),(0,r.ZP)(s,{retries:3})},107:(e,t,n)=>{"use strict";n.d(t,{V:()=>i.V});var i=n(7218)}}]);