...
`;const P=function(e){const{children:t,icon:n}=e;return a.createElement(O,{className:"menu-item"},n,a.createElement("span",{style:{marginLeft:8}},t))};var S=n(2253),N=n(7188);const C=i.ZP.div`
  user-select: none;
  .title {
    padding: 16px ${48}px;
    display: flex;
...
`;function A(){const e=(0,i.s0)(),[t,n]=a.useState(null),[l,s]=a.useState(0),[d,m]=a.useState(!1),[u,p]=a.useState(!0),f=t=>{e(`/admin/edit/add/${t}/0`)},h=(e=0,t=6)=>S(this,void 0,void 0,(function*(){const a=yield(0,o.T6)(e,t,{status:"all"});"string"!=typeof a&&(m(!(e<=0)),e+t>=a.data.totals?p(!1):p(!0),n(a.data.posts))}));return a.useEffect((()=>{h(l,6)}),[l]),a.createElement(N,null,a.createElement(c.h4,null,a.createElement(c.h4.Title,null,"文章管理"),a.createElement(c.h4.Add,null,a.createElement(r.z,{onClick:()=>f("article")},"新增文章"),a.createElement(r.z,{onClick:()=>f("photo")},"添加图片"))),a.createElement(C,null,a.createElement("div",{className:"table"},a.createElement(w,{posts:t,onEdit:t=>{e(`/admin/edit/update/${t.type}/${t.uid}`)},onDel:e=>{const t=e.uid;confirm("确定要删除？")&&(()=>{S(this,void 0,void 0,(function*(){const e=yield(0,o.fR)(t);"string"!=typeof e?(window.alert("删除成功"),h()):window.alert(e)}))})()},onView:t=>{e(`/${t.type}/${t.uid}`)}})),a.createElement("div",{className:"prev-next"},a.createElement(r.z,{onClick:()=>{n(null),s(l-6)},disabled:!d},"Prev"),a.createElement(r.z,{onClick:()=>{n(null),s(l+6)},disabled:!u},"Next"))))}}}]);