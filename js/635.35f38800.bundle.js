...
`;function o({width:t="100%",height:e=16}){return n.createElement(s,{className:"component-skeleton",style:{width:t,height:e}})}},8432:(t,e,r)=>{"use strict";r.d(e,{Gm:()=>l,IW:()=>a,N7:()=>h,WW:()=>i,ZE:()=>o,_n:()=>n,_p:()=>s,fo:()=>u,mS:()=>c,uh:()=>d});const n="https://api.kevinjobs.com:5000",a=n+"/upload",i=n+"/file/list",s=n+"/file",o=n+"/token",u=n+"/post/list",c=n+"/p",l=n+"/user/list",d=n+"/user",h=n+"/invitation/list"},1635:(t,e,r)=>{"use strict";r.r(e),r.d(e,{default:()=>y});var n=r(2983),a=r(9606),i=r(3891),s=r(7860),o=r.n(s),u=r(7952),c=r(9805),l=r(5577);const d=a.ZP.div`
  padding: 48px 0;
