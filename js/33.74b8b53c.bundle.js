...
`;const S=function(e){const{children:t,icon:n}=e;return a.createElement(O,{className:"menu-item"},n,a.createElement("span",{style:{marginLeft:8}},t))};var P=n(2524),N=n(7645);const C=i.ZP.div`
  user-select: none;
  .title {
    padding: 16px ${48}px;
    display: flex;
