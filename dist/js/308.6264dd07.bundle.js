(self.webpackChunkmint_forge=self.webpackChunkmint_forge||[]).push([[308],{9212:(e,t,a)=>{"use strict";a.d(t,{Zb:()=>p,W2:()=>f,h4:()=>s});var l=a(7294),n=a(9163),i=a(4203);const r=n.ZP.div`
  margin: 8px 0 16px 0;
  padding-bottom: 16px;
...
`;function E(e){const{article:t,visible:a,onSubmit:n,onClose:i}=e,[r,o]=l.useState(),[c,s]=l.useState(),[u,v]=l.useState(),[E,x]=l.useState(),[w,b]=l.useState(),[y,k]=l.useState(),[C,I]=l.useState(),[S,A]=l.useState(),[V,D]=l.useState(),[N,Z]=l.useState(),[P,M]=l.useState(),[z,L]=l.useState(),$=()=>{o(void 0),s(void 0),v(void 0),x(void 0),b(void 0),k(void 0),I(void 0),A(void 0),D(void 0),Z(void 0),M(void 0),L(void 0)};return l.useEffect((()=>{m().use({renderer:p});let e=null;if(e=new(h())("#article-editor"),e.config.onchange=e=>I(e),e.config.height=580,e.create(),t){console.log(t);const{extension:a,content:l}=t;switch(a){case"markdown":e.txt.html(m()(l));break;case"html":e.txt.html(l);break;default:e.txt.html(l)}}return()=>e.destroy()}),[t]),l.createElement(d.Vq,{width:1200,height:700,title:"文件编辑器",visible:a,onCancel:e=>{$(),i(e)},animation:"slide-top-down"},l.createElement("div",{style:{display:"flex",flexWrap:"nowrap"}},l.createElement(g,{id:"article-editor"}),t&&(Y=t,l.createElement(f,null,l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"UID",value:r,onChange:e=>o(e.target.value),defaultValue:Y.uid})),l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"ID",value:c,onChange:e=>s(Number(e.target.value)),defaultValue:Y.id})),l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"标题",value:u,onChange:e=>v(e.target.value),defaultValue:Y.title})),l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"作者",value:E,onChange:e=>x(e.target.value),defaultValue:Y.author})),l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"创建",value:w,onChange:e=>b(e.target.value),defaultValue:Y.createAt})),l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"更新",value:y,onChange:e=>k(e.target.value),defaultValue:Y.updateAt})),l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"封面",value:S,onChange:e=>A(e.target.value),defaultValue:Y.cover})),l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"简介",value:V,onChange:e=>D(e.target.value),defaultValue:Y.excerpt})),l.createElement("div",{className:"article-item"},l.createElement(d.II,{label:"标签",value:N,onChange:e=>Z(e.target.value),defaultValue:Y.tags})),l.createElement("div",{className:"article-item",style:{margin:"8px 0"}},l.createElement("label",{style:{marginRight:16}},"格式"),l.createElement("select",{value:P,onChange:e=>M(e.target.value),defaultValue:Y.extension},l.createElement("option",{value:"html"},"HTML"),l.createElement("option",{value:"text"},"纯文本"),l.createElement("option",{value:"markdown"},"Markdown"))),l.createElement("div",{className:"article-item",style:{margin:"8px 0"}},l.createElement("label",{style:{marginRight:16}},"发布"),l.createElement("select",{value:z,onChange:e=>L(e.target.value),defaultValue:Y.publish},l.createElement("option",{value:"public"},"公开"),l.createElement("option",{value:"private"},"隐藏"),l.createElement("option",{value:"draft"},"草稿"))),l.createElement("div",{style:{textAlign:"center",marginTop:24}},l.createElement(d.zx,{onClick:e=>((e,t)=>{e.preventDefault();const a={uid:r||t.uid,id:c||t.id,title:u||t.title,author:E||t.author,createAt:w||t.createAt,updateAt:y||t.updateAt,content:C||t.content,cover:S||t.cover,excerpt:V||t.excerpt,tags:N||t.tags,extension:P||t.extension,publish:z||t.publish};n(e,a),$()})(e,Y)},Y.uid?"更新":"新增"),l.createElement(d.zx,{type:"light",onClick:i},"取消"))))));var Y}var x=a(9212);const w=n.ZP.div`
  .options {
    display: flex;
    align-items: center;
  }
